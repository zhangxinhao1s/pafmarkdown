...
export function renderLabel(h, data, context) {
  // console.log("renderLabel----data==",data)
  ...
  let { labelWidth, labelClassName, selectedClassName, selectedKey,activeClassName,activeKey } = props
  ...
  if (typeof activeClassName === 'function') {
    activeClassName = activeClassName(data)
  }

  activeClassName && activeKey && data[activeKey] && cls.push(activeClassName)
