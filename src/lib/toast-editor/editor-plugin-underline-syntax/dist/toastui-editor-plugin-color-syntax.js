...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ underlinePlugin; }
});
 ...
 */
function underlinePlugin(context, options) {
    ...
    var toolbarItem = {
        ...
        el: document.createElement('button'), // 直接创建 button 元素
        command: 'underlineTexts', // 直接绑定命令
    };
    
    // // 创建包含 SVG 的按钮元素
    toolbarItem.el.innerHTML = `
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M5 21h14v-2H5v2zm7-4c3.31 0 6-2.69 6-6V3h-2v8c0 2.21-1.79 4-4 4s-4-1.79-4-4V3H6v8c0 3.31 2.69 6 6 6z" fill="currentColor"/>
        </svg>  
    `;
    toolbarItem.el.style.background = 'none';
    toolbarItem.el.addEventListener('click', () => {
        eventEmitter.emit('command', 'underlineTexts');
    });
    return {
        wysiwygCommands: {
            underlineTexts: function (_a, _b, dispatch) {
